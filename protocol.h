...
#define                                 MolReader_HtlcWitness_get_blockheader(s)        mol_table_slice_by_index(s, 0)
#define                                 MolReader_HtlcWitness_get_secret(s)             mol_table_slice_by_index(s, 1)
...
#define                                 MolBuilder_HtlcWitness_set_blockheader(b, p, l) mol_table_builder_add(b, 0, p, l)
#define                                 MolBuilder_HtlcWitness_set_secret(b, p, l)      mol_table_builder_add(b, 1, p, l)
MOLECULE_API_DECORATOR  mol_seg_res_t   MolBuilder_HtlcWitness_build                    (mol_builder_t);
#define                                 MolBuilder_HtlcWitness_clear(b)                 mol_builder_discard(b)
...
MOLECULE_API_DECORATOR mol_errno MolReader_HtlcWitness_verify (const mol_seg_t *input, bool compatible) {
    if (input->size < MOL_NUM_T_SIZE) {
        return MOL_ERR_HEADER;
    }
    uint8_t *ptr = input->ptr;
...
MOLECULE_API_DECORATOR mol_seg_res_t MolBuilder_HtlcWitness_build (mol_builder_t builder) {
    mol_seg_res_t res;
    res.errno = MOL_OK;
    mol_num_t offset = 12;
    mol_num_t len;
